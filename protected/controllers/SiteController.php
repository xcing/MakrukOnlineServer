...
class SiteController extends Controller {
    ...
    public function actionIndex() {
        ...
        $trickArticleDatas = Content::model()->findAllByAttributes(
                array(
        ...
        $reviewArticleDatas = Content::model()->findAllByAttributes(
                array(
            //'gameId' => Yii::app()->params['gameId'],
            'type' => 3,
            'active' => 1,
        ...
        /*
          $videoArticleDatas = Article::model()->findAllByAttributes(
          array(
          //'gameId' => Yii::app()->params['gameId'],
          'type' => 4,
          'active' => 1,
