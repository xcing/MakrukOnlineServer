...
<div class="menu_block_xs visible-xs">
     <div class="clear"></div>
        <div class="heade_mid">
            <h1 style="padding:10px"><a href="<?= Yii::app()->createUrl('site/index');?>" style="width:160px"><img src="images/logo-gurugames3.png" alt="gurugames" style="width:100px"><img src="images/logonewfont.png" alt="gurugames" style="height:35px;margin-top:15px"></a> </h1>
            <!-- <div class="autor">
                <?php if(Yii::app()->user->isGuest){ ?>
                    คุณยังไม่ได้เป็นสมาชิกกับเรา?   <a href="<?= Yii::app()->createUrl('site/login');?>">Login</a>  หรือ  <a href="<?= Yii::app()->createUrl('site/register');?>">Register</a>
                <?php }
