...
class User extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('username, md5_password', 'required', 'message' => '{attribute} ต้องไม่เป็นค่าว่าง'),
            array('role, active', 'numerical', 'integerOnly' => true, 'message' => '{attribute} ต้องเป็นตัวเลขเท่านั้น'),
            array('username', 'unique', 'message' => '{attribute} นี้ถูกใช้แล้ว'),
